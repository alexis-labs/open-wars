...
const mission1: TutorialMissionDefinition = {
  ...
  effects: createTutorialEffects(
      [
        msg(Pioneer, "Commander, welcome to Boot Camp. This is your first field mission."),
        msg(Pioneer, "Intel reports a neutral outpost to the east. We need it before the enemy can react.", 1),
        msg(Infantry, "Select your Pioneer, then tap a green tile to move. Highlighted tiles show where it can go."),
        msg(Pioneer, "When you reach the outpost, choose Capture. Buildings give map control and income.", 2),
        msg(Infantry, "An enemy soldier is nearby, but ignore him for now. Focus on the capture. Good luck!", 1),
      ],
      [
        msg(Pioneer, "Mission complete! You captured the outpost like a seasoned commander."),
        msg(Infantry, "You now know movement and capture — the heart of Open Wars. On to the next lesson.", 1),
      ],
      [
        msg(Pioneer, "The mission failed, Commander, but every attempt teaches something new.", 1),
        msg(Infantry, "Tip: select the Pioneer, move to the marked neutral building, and choose Capture."),
      ],
    ),
  id: tutorialMapIds[0],
  map: buildTutorialMap({
      ...
      units: [
        [1, 2, { g: 40, h: 100, i: Pioneer.id, p: 1 }],
        [9, 8, { g: 40, h: 100, i: Pioneer.id, p: 2 }],
      ],
    }),
